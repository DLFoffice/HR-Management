...
.leave-doc{ max-width:100%; margin:0 auto; font-size:13px; line-height:1.85; color:#232323; }
...
.leave-doc-meta{ text-align:right; font-size:12px; color:#666; margin-bottom:16px; }
.leave-doc-meta div{margin-bottom:2px;}
.leave-doc-intro{margin-bottom:16px;}
.leave-doc-field{margin-bottom:9px;}
.leave-doc-indent{padding-left:36px;}
.leave-doc-label{font-weight:700; color:#111; display:inline-block; min-width:38px;}
.leave-doc-blank{border-bottom:1px dotted #999; display:inline-block; min-width:52px; padding:0 3px;}
.leave-doc-block{ margin:16px 0; padding:14px 16px; background:#FAFAFC; border:1px solid #E6E4F0; border-left:3px solid var(--lav-2); border-radius:6px; }
.leave-doc-block-title{font-weight:700; font-size:12px; color:var(--lav-deep); margin-bottom:10px; letter-spacing:.2px; text-transform:none;}
.leave-doc-block .leave-doc-field{margin-bottom:6px;}
.leave-doc-block .leave-doc-field:last-child{margin-bottom:0;}
.leave-doc-check-grid{ display:grid; grid-template-columns:repeat(4, minmax(0,1fr)); gap:8px 10px; margin-bottom:10px; }
.leave-doc-check-grid .leave-doc-check{font-size:12.5px; white-space:nowrap;}
.leave-doc-contact-grid{ display:grid; grid-template-columns:1fr 1fr; gap:6px 20px; }
.leave-doc-contact-grid .full{grid-column:1 / -1;}
.leave-doc-section{margin-top:24px; padding-top:16px; border-top:1px dashed #ccc;}
.leave-doc-section-title{font-weight:700; margin-bottom:10px; color:var(--lav-deep); font-size:13.5px;}
.leave-doc-sign{text-align:center; margin-top:28px;}
.leave-doc-sign .sign-line{margin:32px 0 4px; letter-spacing:2px; color:#888;}
.leave-doc-approval{ display:grid; grid-template-columns:1fr 1fr; gap:0; margin-top:26px; border-top:1px solid #ddd; }
.leave-doc-approval > div{padding:16px 18px 4px;}
.leave-doc-approval > div:first-child{border-right:1px dashed #ccc;}
...
function sickPersonalFormPrintHtml(rec, emp, submit){
  ...
  <div class="leave-doc">
    ...
    <div class="leave-doc-intro">
      <div class="leave-doc-field"><span class="leave-doc-label">เรื่อง</span>ขออนุญาตลา${isSick?'ป่วย':isPersonal?'กิจ':''}</div>
      <div class="leave-doc-field"><span class="leave-doc-label">เรียน</span>หัวหน้าสำนักงาน</div>
    ...
    <div class="leave-doc-block">
      <div class="leave-doc-block-title">คำร้องขอลา</div>
      <div class="leave-doc-check-grid">
        <span class="leave-doc-check">${checkbox(isSick)} ป่วย</span>
        <span class="leave-doc-check">${checkbox(isPersonal)} ลากิจส่วนตัว</span>
        <span class="leave-doc-check">${checkbox(false)} คลอดบุตร</span>
        <span class="leave-doc-check">${checkbox(false)} อื่นๆ</span>
      </div>
      <div class="leave-doc-field">เนื่องจาก ${blankOr(rec.reason)}</div>
      <div class="leave-doc-field">ตั้งแต่วันที่ ${blankOr(buddhistDate(rec.startDate))} ถึงวันที่ ${blankOr(buddhistDate(rec.endDate))} มีกำหนด ${blankOr(rec.days)} วัน</div>
    </div>

    <div class="leave-doc-block">
      <div class="leave-doc-block-title">ประวัติการลาประเภทเดียวกัน (ครั้งก่อนหน้า)</div>
      <div class="leave-doc-check-grid">
        <span class="leave-doc-check">${checkbox(isSick)} ป่วย</span>
    ...
    <div class="leave-doc-block">
      ...
      <div class="leave-doc-contact-grid">
        <div>บ้านเลขที่ ${blankOr(rec.contactAddress)}</div>
        <div>ตรอก/ซอย ${blankOr(rec.contactSoi)}</div>
        <div>ตำบล/แขวง ${blankOr(rec.contactTambon)}</div>
        <div>อำเภอ/เขต ${blankOr(rec.contactAmphoe)}</div>
        <div>จังหวัด ${blankOr(rec.contactProvince)}</div>
...
function vacationFormPrintHtml(rec, emp, submit){
  ...
  <div class="leave-doc">
    ...
    <div class="leave-doc-intro">
      <div class="leave-doc-field"><span class="leave-doc-label">เรื่อง</span>ขออนุญาตลาพักผ่อน</div>
      <div class="leave-doc-field"><span class="leave-doc-label">เรียน</span>หัวหน้าสำนักงานมูลนิธิฯ</div>
      <div class="leave-doc-field leave-doc-indent">ข้าพเจ้า ${blankOr(emp.name)} ตำแหน่ง ${blankOr(emp.position)}</div>
    </div>
