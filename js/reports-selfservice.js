...
.leave-doc{ max-width:100%; margin:0 auto; font-size:13px; line-height:1.9; color:#202020; }
...
.leave-doc-meta{ text-align:right; font-size:12px; color:#555; margin-bottom:18px; }
.leave-doc-meta div{margin-bottom:2px;}
.leave-doc-field{margin-bottom:10px;}
.leave-doc-indent{padding-left:36px;}
.leave-doc-checks{ display:flex; flex-wrap:wrap; column-gap:32px; row-gap:6px; margin:2px 0 11px; padding-left:36px; }
...
.leave-doc-sign{text-align:left; margin-top:22px;}
.leave-doc-sign .sign-line{margin:30px 0 4px;}
.leave-doc-approval{ display:grid; grid-template-columns:1fr 1fr; gap:32px; margin-top:26px; padding-top:18px; border-top:1px solid #ddd; }
...
function sickPersonalFormPrintHtml(rec, emp, submit){
  ...
  return `
  <div class="leave-doc">
    <div class="leave-doc-title">ใบลาป่วย ลาคลอด และลากิจ</div>
    <div class="leave-doc-meta">
      <div>เขียนที่ ${esc(ORG_FULL_NAME)}</div>
      <div>วันที่ ${blankOr(submit.day)} เดือน ${blankOr(submit.month)} พ.ศ. ${blankOr(submit.year)}</div>
    </div>
    <div class="leave-doc-field">เรื่อง&emsp;ขออนุญาตลา${isSick?'ป่วย':isPersonal?'กิจ':''}</div>
    <div class="leave-doc-field">เรียน&emsp;หัวหน้าสำนักงาน</div>
    <div class="leave-doc-field leave-doc-indent">ข้าพเจ้า ${blankOr(emp.name)} ตำแหน่ง ${blankOr(emp.position)}</div>
    <div class="leave-doc-field">สังกัด (สถานี/สำนักงาน) ${blankOr(emp.department)} ${esc(ORG_FULL_NAME)}</div>

    <div class="leave-doc-field leave-doc-indent" style="margin-bottom:2px;">ขอลา</div>
    ...
    <div class="leave-doc-field" style="margin-bottom:2px;">ข้าพเจ้าได้ลา</div>
    ...
    <div class="leave-doc-field">ในระหว่างลาจะติดต่อข้าพเจ้าได้ที่บ้านเลขที่ ${blankOr(rec.contactAddress)} ตรอก/ซอย ${blankOr(rec.contactSoi)}</div>
    ...
    <div class="leave-doc-approval">
      <div>
        ...
        <div class="approval-line">&nbsp;</div>
        <div style="margin-top:14px;">ลงชื่อ ........................................</div>
      ...
      <div>
        ...
        <div style="margin-top:52px;">ลงชื่อ ........................................</div>
...
function vacationFormPrintHtml(rec, emp, submit){
  ...
  return `
  <div class="leave-doc">
    <div class="leave-doc-title">แบบใบลาพักผ่อน</div>
    <div class="leave-doc-meta">
      <div>เขียนที่ ${esc(ORG_FULL_NAME)}</div>
      <div>วันที่ ${blankOr(submit.day)} เดือน ${blankOr(submit.month)} พ.ศ. ${blankOr(submit.year)}</div>
    </div>
    <div class="leave-doc-field">เรื่อง&emsp;ขออนุญาตลาพักผ่อน</div>
    <div class="leave-doc-field">เรียน&emsp;หัวหน้าสำนักงานมูลนิธิฯ</div>
    <div class="leave-doc-field leave-doc-indent">ข้าพเจ้า ${blankOr(emp.name)} ตำแหน่ง ${blankOr(emp.position)}</div>
    <div class="leave-doc-field">มีวันลาพักผ่อนสะสม ${blankOr(vac.carry)} วันทำการ มีสิทธิพักผ่อนประจำปีนี้อีก ${blankOr(vac.right)} วันทำการ รวมเป็น ${blankOr(vac.total)} วันทำการ</div>
    <div class="leave-doc-field">ขอลาพักผ่อนตั้งแต่วันที่ ${blankOr(buddhistDate(rec.startDate))} ถึง ${blankOr(buddhistDate(rec.endDate))} มีกำหนด ${blankOr(rec.days)} วันทำการ</div>
    ...
    <div class="leave-doc-approval" style="grid-template-columns:1fr;">
      <div>
        <div class="col-title">คำสั่ง&emsp;${checkbox(false)} อนุญาต&emsp;&emsp;${checkbox(false)} ไม่อนุญาต</div>
        <div class="leave-doc-sign" style="margin-top:44px;">
          <div>ลงชื่อ ........................................</div>
          <div style="margin-top:4px;">( ........................................ )</div>
          <div style="margin-top:4px;">วันที่ ...../...../.....</div>
        </div>
